...
//		else return false;
	...
	/*
	 * private boolean prendi(String nomeAttrezzo) { boolean bool = false;
	 * if(this.partita.getStanzaCorrente().hasAttrezzo(nomeAttrezzo)) {
	 * //if(this.partita.getLabirinto().getStanzaCorrente().getAttrezzo(
	 * nomeAttrezzo) != null) { if((this.partita.getGiocatore().getBorsa().getPeso()
	 * + this.partita.getStanzaCorrente().getAttrezzo(nomeAttrezzo).getPeso()) <=
	 * this.partita.getGiocatore().getBorsa().getDefaultPesoMaxBorsa()) { Attrezzo
	 * attr = this.partita.getStanzaCorrente().getAttrezzo(nomeAttrezzo);
	 * this.partita.getGiocatore().getBorsa().addAttrezzo(attr);
	 * this.partita.getStanzaCorrente().removeAttrezzo(attr); bool = true;
	...
	/*
	 * private boolean posa(String nomeAttrezzo) { boolean bool = false;
	 * if(this.partita.getGiocatore().getBorsa().hasAttrezzo(nomeAttrezzo)) {
	 * Attrezzo attrDaBorsa =
	 * this.partita.getGiocatore().getBorsa().getAttrezzo(nomeAttrezzo);
	 * if(this.partita.getStanzaCorrente().getNumeroAttrezzi() <
	 * this.partita.getStanzaCorrente().getNumeroMassimoAttrezzi() ) {
	 * this.partita.getStanzaCorrente().addAttrezzo(attrDaBorsa);
	 * this.partita.getGiocatore().getBorsa().removeAttrezzo(nomeAttrezzo); bool =
	 * true;
	 ...
	 * ioConsole.mostraMessaggio(elencoComandi[i]+" "); //System.out.println();
...
//	}
	 ...
	 */
	/*
	 * private void fine() { //System.out.println("Grazie di aver giocato!"); // si
	 * desidera smettere ioConsole.mostraMessaggio("Grazie di aver giocato!"); }
	 */
